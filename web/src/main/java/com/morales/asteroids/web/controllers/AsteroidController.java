...
public class AsteroidController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Asteroid data found"),
            @ApiResponse(responseCode = "204", description = "No data found", content = @Content(schema = @Schema(implementation = ApiError.class))),
            @ApiResponse(responseCode = "400", description = "Invalid params provided", content = @Content(schema = @Schema(implementation = ApiError.class))),
